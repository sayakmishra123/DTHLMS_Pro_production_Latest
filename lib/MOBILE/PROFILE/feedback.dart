  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Feedback',style: FontFamily.style.copyWith(color: Colors.white),),),
  ...
  Widget build(BuildContext context) {
     return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Padding(
          padding: EdgeInsets.symmetric(horizontal: horizontalPadding,vertical: h),
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: Image(
                        ...
                        height: 25, // Uncomment if you want to specify the height
                      ),
                    ),
                  ],
                ),
                ...
                Row(children: [Text('Additional feedback',style: FontFamily.styleb.copyWith(fontSize: 16,),)],),
                SizedBox(height: 5),
...
shape: ContinuousRectangleBorder(borderRadius: BorderRadius.circular(25)),
                                ...
                                onPressed: (){},child: Text('Submit feedback',style: FontFamily.style.copyWith(color: Colors.white,fontSize: 16,fontWeight: FontWeight.w800),),),
                            ),
                          ],
                        )
              ],
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10), // Rounded corners
            borderSide: BorderSide(
              color: Colors.grey.withOpacity(0.5), // Grey color for enabled border
            ),
          ),
        ...
        style: TextStyle(fontSize: 16, color: Colors.grey[800]), // Text style inside the field
      ),
    );
  }
}