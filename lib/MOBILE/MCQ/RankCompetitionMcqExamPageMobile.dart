...
class RankCompetitionMcqExamPageMobile extends StatefulWidget {
  ...
  const RankCompetitionMcqExamPageMobile(
      ...
      required this.attempt,  required this.totalDuration, required this.userAnswer, required this.isAnswerSheetShow, required this.totalMarks});
...
class _RankCompetitionMcqExamPageMobileState
  ...
  TextEditingController oneWordController = TextEditingController();
   ...
   OnlineAudioPlayerController audioController = Get.find<OnlineAudioPlayerController>();
        ...
        pageExitConfirmationBox(context);
              ...
              actions: [
                Row(
                  ...
                  children: [
                         widget.examType != "Quick Practice"?  Row(
                      children: [
                        SizedBox(width: 20),
                        Icon(
                                                                          ...
                                                                          Row(
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: Text(fetchSectionName(data.keys.toString().replaceAll("(", "").replaceAll(")", ""))),
                                                                              ),
                                                                            ],
                                                                          ),
                                                                          Container(
                                                                            height:
                                                                                100 * ((indexList.length ~/ 4) + 1),
                                                                            child: GridView.builder(
                                                                                ...
                                                                                "Quick Practice"
                                                                                                  ?  mcqData[offset + ind]
                                                    .mCQQuestionType ==
                                                "One Word Answer"?getOneWordAnswerFromQuestionId(mcqData[offset + ind].questionId.toString()).replaceAll(" ", "").toLowerCase()==onewordAnswerList[mcqData[offset + ind].questionId.toString()].toString().replaceAll(" ", "").toLowerCase() ? Colors.green
                                                                                                      : Colors.red : answer.any((map) => map.values.any((List<int> list) => list.any((item) => userAns[indexList[ind]]!.contains(item))))
                                                                                                      ? Colors.green
                                                                                                      : Colors.red
                                                                                                  : Colors.blue
                                                                      ...
                                                                      // .pause();
                                                                                        ...
                                                                                        Get.back();
                                                                                          oneWordController.text=onewordAnswerList[mcqData[qindex.value]
                                                    .questionId]??"";
                                              ...
                                              Container(
                                                ...
                                                child: mcqData[qindex.value]
                                                    ...
                                                    ? Center(
                                                        child: Text(
                                                            "No video Found"))
                                                    :isYouTubeUrl(mcqData[qindex.value]
                                                            .mCQQuestionUrl)? 
...
:VideoPlayerMcq(mcqData[qindex.value]
                                                            .mCQQuestionUrl)
                                              ),
                                            if (mcqData[qindex.value]
                                                        .mCQQuestionType ==
                                                ...
                                                getx.isInternet.value)
                                              mcqData[qindex.value]
                                                        .documnetUrl==""?Container(child:Center(child:Text("No Audio found"))):  Container(
                                                // height: 400,
                                                // width: MediaQuery.of(context).size.width/3,
                                                margin: EdgeInsets.symmetric(
                                                    vertical: 20),
                                                child:
                                                OnlineAudioPlayer(url:  mcqData[qindex.value]
                                                        .documnetUrl,),
                                                //  Container(
                            ...
                            child: SizedBox(
                              ...
                              child: Column(
                                children: [
                                  SizedBox(height: 20),
                                  SizedBox(  
                                    height: mcqData[qindex.value].mCQQuestionType ==
                                        "One Word Answer"
                                    ?200:
        ...
        bool isCorrect;
                                      ...
                                      if   (mcqData[qindex.value]
                                                    .mCQQuestionType ==
                                                "One Word Answer"){
                                                     isCorrect = getOneWordAnswerFromQuestionId(questionId.toString()).replaceAll(" ", "").toLowerCase()==getOneWordAnswerFromQuestionIdofStudent(questionId.toString()).replaceAll(" ", "").toLowerCase();
                                                }else{
                                            ...
                                            children: [
                                              Container(
                                                // color: Colors.red,
                                                  child: SizedBox(
                                                      child: TextFormField(
                                                        readOnly: userAns.containsKey(int.parse(
                                                                      questionId))&& widget.examType=="Quick Practice",
                                                        onSaved: (value){
                                                      ...
                                                      if (!isSubmitted.value) {     if( oneWordController.text!=""){
                                                           userAns[int.parse(
                                                                      questionId)] = [
                                                                    int.parse(
                                                                        optionId)
                                                   ...
                                                   userAns.containsKey(int.parse(
                                                                      questionId))                                          && widget.examType=="Quick Practice"?   Align( alignment: Alignment.centerLeft,  child: Container( margin: EdgeInsets.symmetric(vertical: 10),  padding: EdgeInsets.all(15),   decoration: BoxDecoration(
                                                  borderRadius:
                                                      BorderRadius.all(
                                                          Radius.circular(10)),
                                                  color: Colors.white,
                                                  ...
                                                  ]),child: Text("Answer : ${getOneWordAnswerFromQuestionId(questionId.toString())} ") ,))
                                           :SizedBox()
                                            ],
                                          )
                                          :  Padding(
...
if(widget.examType ==
                                      ...
                                      showAnswerExplenetion.value && widget.examType=="Quick Practice" && mcqData[qindex.value].answerExplanation!="0"?Row(children: [Expanded(
    ...
    ''');
                                            ...
                                            ): SingleChildScrollView(child: HtmlWidget(mcqData[qindex.value].answerExplanation)),),
                                )],):SizedBox(),
                                SizedBox(height: 20,),
                                  Row(
                                    mainAxisAlignment:
                                    ...
                                    children: [
                                      ...
                                      Visibility(
                                        visible: widget.examType!="Quick Practice",
                                        child: Obx(
                                          () => Flexible(
                                            child: MaterialButton(
                                              height: 40,
                                              color:
                                                  !reviewlist.contains(qindex.value)
                                                      ? Colors.orange
                                                      : Colors.blueGrey,
          ...
          onPressed: () async {
            ...
            for (var question in mcqData) {
                  ...
                  if(getQuestionTypeFromId(questionId.toString())=="One Word Answer"){
                     updateOneWordAnswerofStudent(
                                                     correctAnswerIds[0].toString(),
                                                        questionId.toString(),
                                                        onewordAnswerList.containsKey(questionId.toString())?onewordAnswerList[questionId.toString()]??"Not answerd":"Not answerd"
                                                        );
              ...
              resultJsonData.add({
               ...
               "userselectedanswer":getQuestionTypeFromId(questionId.toString())=="One Word Answer"?onewordAnswerList.containsKey(questionId.toString())?[onewordAnswerList[questionId.toString()]??["Not answerd"]]:["Not answerd"]: userSelectedAnswerTexts,
              });
...
//  double obtainmarks=calculateTotalMarkOfQuestion(questionId.toString(),selectedOptionIds)
              // Check if the user provided an answer; if not, set "Not Answered"
              List<int> selectedOptionIds = userAns[questionId] ?? [];
               double obtainmarks=calculateTotalMarkOfQuestion(questionId.toString(),selectedOptionIds,getQuestionTypeFromId(questionId.toString()));
              List<String> userSelectedAnswerTexts = selectedOptionIds
                      .isNotEmpty
                  ? selectedOptionIds
                      .map((id) => question.options
           ...
           double totalmarks =calculateTotalMarks(resultJsonData);
            if(getx.isInternet.value){
             senddatatoRankedmcqtest(context, getx.loginuserdata[0].token,
                questionAnswerListofStudent,(totalDuration.value-(_start.value/60)).toString());
         }
            updateTblUserResultDetails(
                "true", widget.paperId, UtcTime().utctime().toString());
...
class OnlineAudioPlayer extends StatelessWidget {
  final String url;
  final OnlineAudioPlayerController controller = Get.put(OnlineAudioPlayerController());
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Obx(() => IconButton(
                    icon: Icon(controller.isPlaying.value ? Icons.pause : Icons.play_arrow,size:45 ,),
