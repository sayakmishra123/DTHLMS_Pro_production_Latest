                        ...
                        child: Column(
                          children: [
                            ...
                            _buildDrawerItem(
                             ...
                             _buildDrawerItem(
                                Icons.rotate_left_rounded, "Refund Policy", () {
                              pageIndex.value = 10;
                            }, pageIndex.value == 10 ? true : false),


                              _buildDrawerItem(
                                Icons.question_mark_outlined, "Term & Condition", () {
                              pageIndex.value = 11;
                            }, pageIndex.value == 11 ? true : false),
...
class PrivacyPollicyWidget extends StatefulWidget {
  @override
  State<PrivacyPollicyWidget> createState() => _PrivacyPollicyWidgetState();
}

class _PrivacyPollicyWidgetState extends State<PrivacyPollicyWidget> {
...
@override
 ...
 privacyPolicy.value=   getValuefromTblSettingByfeilName("Privacy & Policy");
...
class _RefundPolicyState extends State<RefundPolicy> {
 ...
 refundPolicy.value=   getValuefromTblSettingByfeilName("Refund Policy");
...
class _TermAndConditionWidgetState extends State<TermAndConditionWidget> {
  RxString termAndCondition="".obs;


   void initState() {
    // getPrivacyPolicyRefundPolicyTermsAndConndition(context,getx.loginuserdata[0].token);

 termAndCondition.value=   getValuefromTblSettingByfeilName("Terms & Conditions");
